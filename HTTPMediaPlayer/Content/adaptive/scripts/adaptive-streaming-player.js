$(function () {
    ...
    var BasicPlayer = function () {
        ...
        Cluster.prototype._getClusterData = function (callback, retryCount) {
            ...
            var vidUrl =
                ...
                //"/english-breakfast-1.mp4";
                //"/api/sample/mp4/teste123";
            //self.sourceFile + this.rendition + '.webm';
            if (retryCount) {
    ...
    window.updatePlayer = function () {
        var sourceFile = '../../Content/adaptive/vidData/example';
        var clusterData = '../../Content/adaptive/vidData/example';
