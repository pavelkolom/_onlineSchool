...
namespace HTTPMediaPlayerCore.Migrations
{
    ...
    [Migration("20201211150341_AuthorAndCourseHeaderFilterAndContactForm")]
    partial class AuthorAndCourseHeaderFilterAndContactForm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTTPMediaPlayerCore.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ContactFormButtonText")
                        .HasColumnType("NVARCHAR(10)");

                    b.Property<string>("ContactFormHeaderText")
                        .HasColumnType("NVARCHAR(20)");

                    b.Property<string>("ContactFormMessageBoxText")
                        .HasColumnType("NVARCHAR(50)");
                    ...
                    b.Property<bool?>("HasOwnRobokassa")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("RobokassaPassword1")
                        .HasColumnType("NVARCHAR(30)");

                    b.Property<string>("RobokassaPassword2")
                        .HasColumnType("NVARCHAR(30)");

                    b.Property<string>("RobokassaShopId")
                        .HasColumnType("NVARCHAR(30)");

                    b.Property<string>("RobokassaTestPassword1")
                        .HasColumnType("NVARCHAR(30)");

                    b.Property<string>("RobokassaTestPassword2")
                        .HasColumnType("NVARCHAR(30)");
            ...
            modelBuilder.Entity("HTTPMediaPlayerCore.Models.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HTTPMediaPlayerCore.Models.Author", b =>
                {
                    b.HasOne("HTTPMediaPlayerCore.Models.Filter", "Filter")
                        .WithMany()
            ...
            modelBuilder.Entity("HTTPMediaPlayerCore.Models.AuthorCourse", b =>
                {
                    b.HasOne("HTTPMediaPlayerCore.Models.Author", "Author")
                    ...
                    b.HasOne("HTTPMediaPlayerCore.Models.User", null)
                        .WithMany("AuthorCourses")
                        .HasForeignKey("UserId");
