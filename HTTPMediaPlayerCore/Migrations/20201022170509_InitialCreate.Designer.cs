...
namespace HTTPMediaPlayerCore.Migrations
{
    ...
    [Migration("20201022170509_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTTPMediaPlayerCore.Models.CourseAuthor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HTTPMediaPlayerCore.Models.CourseAuthor", b =>
                {
                    b.HasOne("HTTPMediaPlayerCore.Models.Course", "Course")
                        .WithOne("CourseAuthor")
                        .HasForeignKey("HTTPMediaPlayerCore.Models.CourseAuthor", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
