...
namespace HTTPMediaPlayerCore.Models
{
  ...
  public class AuthorCheck : IActionFilter
  {
    public void OnActionExecuting(ActionExecutingContext filterContext)
    {
      string sessionUserID = filterContext.HttpContext.Session.GetString("IsAuthor");
      ...
      if (string.IsNullOrEmpty(sessionUserID) || sessionUserID != "True")
